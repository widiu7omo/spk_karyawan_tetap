                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-between py-2">
                        ...
                        <div class="float-right">
                            <a class="btn btn-primary btn-sm" href="spk-management.php?f=simpan">Tambah</a>
                        </div>
                    </div>
                </div>
                <div class="row">
			                                    ...
			                                    <?php if ( count( $data_kriterias ) > 0 ): ?>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <button type="button" id="btn-modal" class="btn btn-danger btn-sm"
                                                                    data-toggle="modal"
                                                                    data-target="#header-filled-error-modal" data-id="<?php echo $kary->id ?>">
                                                                <i class="mdi mdi-delete"></i>
                                                            </button>
<!--                                                            <a href="model/data-kriteria.php?f=delete&id=--><?php //echo $kary->id ?><!--"-->
